...
//const imageBaseUrl = "http://localhost:5173/uploads/";
...
const CreateMovie = () => {
          ...
          const [movieData, setMovieData] = useState({
                    ...
                    image: null,
                    genre: "",
                    url: "", // Add video field to store movie link
          });
          ...
          const handleCreateMovie = async () => {
                    try {
                              if (
                                        ...
                                        !movieData.cast ||
                                        !selectedImage ||
                                        !movieData.url // Ensure movie link is provided
                              ) {
                              ...
                              if (selectedImage) {
                                        ...
                                        navigate("/admin/movies/movie-list");
