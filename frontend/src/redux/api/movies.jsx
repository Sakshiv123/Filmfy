...
export const moviesApiSlice = apiSlice.injectEndpoints({
          endpoints: (builder) => ({
                    ...
                    // New mutation for adding/updating movie's watch link
                    updateMovieWatchLink: builder.mutation({
                              query: ({ id, watchLink }) => ({
                                        url: `${MOVIE_URL}/update-movie/${id}/watch-link`,
                                        method: "PATCH", // PATCH to partially update just the link
                                        body: { watchLink },
                              }),
                    }),
